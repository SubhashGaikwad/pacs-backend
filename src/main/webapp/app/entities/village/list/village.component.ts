...
import { EntityArrayResponseType, VillageService } from '../service/village.service';
...
export class VillageComponent implements OnInit {
  ...
  trackId = (_index: number, item: IVillage): number => this.villageService.getVillageIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.villages = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IVillage[] | null): IVillage[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.villageService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
