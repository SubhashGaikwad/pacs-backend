...
import { EntityArrayResponseType, AddressDetailsService } from '../service/address-details.service';
...
export class AddressDetailsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAddressDetails): number => this.addressDetailsService.getAddressDetailsIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.addressDetails = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IAddressDetails[] | null): IAddressDetails[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.addressDetailsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
