...
describe('AddressDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'address-details', component: AddressDetailsComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to addressDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAddressDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAddressDetailsIdentifier).toHaveBeenCalledWith(entity);
