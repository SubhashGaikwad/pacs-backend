...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../address-details.test-samples';

import { AddressDetailsService, RestAddressDetails } from './address-details.service';

const requireRestSample: RestAddressDetails = {
...
describe('AddressDetails Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a AddressDetails', () => {
      ...
      const addressDetails = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(addressDetails).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a AddressDetails', () => {
      const addressDetails = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(addressDetails).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addAddressDetailsToCollectionIfMissing', () => {
      it('should add a AddressDetails to an empty array', () => {
        const addressDetails: IAddressDetails = sampleWithRequiredData;
      ...
      it("should add a AddressDetails to an array that doesn't contain it", () => {
        const addressDetails: IAddressDetails = sampleWithRequiredData;
        const addressDetailsCollection: IAddressDetails[] = [sampleWithPartialData];
        expectedResult = service.addAddressDetailsToCollectionIfMissing(addressDetailsCollection, addressDetails);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(addressDetails);
      });
      ...
      it('should add only unique AddressDetails to an array', () => {
        const addressDetailsArray: IAddressDetails[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const addressDetailsCollection: IAddressDetails[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const addressDetails: IAddressDetails = sampleWithRequiredData;
        const addressDetails2: IAddressDetails = sampleWithPartialData;
    ...
    describe('compareAddressDetails', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareAddressDetails(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareAddressDetails(entity1, entity2);
        const compareResult2 = service.compareAddressDetails(entity2, entity1);
