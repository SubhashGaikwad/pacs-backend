...
import com.techvg.pacs.repository.StateRepository;
import com.techvg.pacs.service.StateQueryService;
import com.techvg.pacs.service.StateService;
import com.techvg.pacs.service.criteria.StateCriteria;
...
/**
 * REST controller for managing {@link com.techvg.pacs.domain.State}.
 */
@RestController
@RequestMapping("/api")
public class StateResource {
    ...
    public ResponseEntity<List<StateDTO>> getAllStates(
        ...
        log.debug("REST request to get States by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countStates(StateCriteria criteria) {
        log.debug("REST request to count States by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
