...
import com.techvg.pacs.repository.DistrictRepository;
import com.techvg.pacs.service.DistrictQueryService;
import com.techvg.pacs.service.DistrictService;
import com.techvg.pacs.service.criteria.DistrictCriteria;
...
/**
 * REST controller for managing {@link com.techvg.pacs.domain.District}.
 */
@RestController
@RequestMapping("/api")
public class DistrictResource {
    ...
    public ResponseEntity<List<DistrictDTO>> getAllDistricts(
        ...
        log.debug("REST request to get Districts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countDistricts(DistrictCriteria criteria) {
        log.debug("REST request to count Districts by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
