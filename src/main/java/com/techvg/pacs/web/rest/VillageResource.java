...
import com.techvg.pacs.service.VillageQueryService;
import com.techvg.pacs.service.VillageService;
...
/**
 * REST controller for managing {@link com.techvg.pacs.domain.Village}.
 */
@RestController
@RequestMapping("/api")
public class VillageResource {
    ...
    public ResponseEntity<List<VillageDTO>> getAllVillages(
        ...
        log.debug("REST request to get Villages by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
        Page<VillageDTO> page = villageQueryService.findByCriteria(criteria, pageable);
    ...
    public ResponseEntity<Long> countVillages(VillageCriteria criteria) {
        log.debug("REST request to count Villages by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
