...
import com.techvg.pacs.repository.TalukaRepository;
import com.techvg.pacs.service.TalukaQueryService;
import com.techvg.pacs.service.TalukaService;
import com.techvg.pacs.service.criteria.TalukaCriteria;
...
/**
 * REST controller for managing {@link com.techvg.pacs.domain.Taluka}.
 */
@RestController
@RequestMapping("/api")
public class TalukaResource {
    ...
    public ResponseEntity<List<TalukaDTO>> getAllTalukas(
        ...
        log.debug("REST request to get Talukas by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countTalukas(TalukaCriteria criteria) {
        log.debug("REST request to count Talukas by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
